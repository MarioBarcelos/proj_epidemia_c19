...
config() {
  ...
  docker network create proj_epidemia_c19
  docker network connect proj_epidemia_c19 airbyte-proxy
  docker network connect proj_epidemia_c19 airbyte-worker  
  docker network connect proj_epidemia_c19 airflow-airflow-worker-1
  docker network connect proj_epidemia_c19 airflow-airflow-webserver-1
  docker network connect proj_epidemia_c19 metabase
